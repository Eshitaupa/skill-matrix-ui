...
export default function SkillMatrix({
   ...
   *
   * IMPORTANT:
   * ADD ROW does not use this
   * anymore because a slow
   * Databricks save should not
   * freeze the whole toolbar.
   */
  const [
    actionBusy,
    setActionBusy,
  ...
  /*
   * Engineer-only discipline
   * inside Add Row modal.
   */
  const isAddRoleLocked =
    Boolean(
      DISCIPLINE_ROLE_MAP[
        form.discipline
      ]
  ...
  async function handleAddRow() {
     ...
     * check actionBusy here.
     *
     * Adding one row should not
     * lock the Add Row workflow
     * while Databricks finishes
    ...
    /*
     * CLOSE CARD RIGHT AWAY.
     */
    setShowAddRow(false);

    /*
     * Track add save separately.
     *
     * DO NOT:
     * setActionBusy(true)
     *
     * This is the actual fix for
     * Add Row becoming disabled.
     */
    setAddSaving(true);
        ...
        <div className="smf-toolbar-row">
          ...
          <div className="smf-toolbar-left">
            ...
            {/*
              ...
              Add Row stays clickable
              even while an earlier Add
              request is saving.
            */}
        ...
        <div className="sm-add-overlay">
          ...
          <div className="sm-add-modal">
            ...
            <div className="sm-add-actions">
              ...
              {/*
                IMPORTANT:
                actionBusy is NOT used.

                The modal does not need
                to wait for a previous
                Databricks insert.
              */}
