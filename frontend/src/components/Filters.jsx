    ...
    <div className="smf-bar">
      <style>
        {`
          ...
          .smf-bar select.smf-skill-select {
...
.smf-bar input.smf-skill-search {
  ...
  width: 100% !important;
      ...
      {/* Skill dropdown — auto-populated from the skill categories
          (the light-blue group headers) that belong to the
          currently selected discipline + role */}
      <select
        className="smf-select smf-skill-select"
